...
function SpcEdit(Obj){
    ...
    console.log($(Obj).closest('.personal-spc').find('.spc-qty'))
    $(Obj).closest('.personal-spc').find('.spc-qty').css("display","none");
    $(Obj).closest('.personal-spc').find('.spc-item-delete').css("display","block");
    $(Obj).closest('.group-spc').find('.spc-qty').css("display","none");
    $(Obj).closest('.group-spc').find('.spc-item-delete').css("display","block");
}
function SpcEditDone(Obj){
    Obj.innerText = "編輯";
    Obj.setAttribute("onclick","SpcEdit(this)");
    $(Obj).closest('.personal-spc').find('.spc-qty').css("display","block");
    $(Obj).closest('.personal-spc').find('.spc-item-delete').css("display","none");
    $(Obj).closest('.group-spc').find('.spc-qty').css("display","block");
    $(Obj).closest('.group-spc').find('.spc-item-delete').css("display","none");
}
